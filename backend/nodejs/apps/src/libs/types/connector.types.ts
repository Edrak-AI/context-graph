export enum ConnectorId {
    ...
    MICROSOFT_BUSINESS_CENTRAL = 'microsoftBusinessCentral',
    SAP = 'sap',
    SLACK = 'slack',
    DROPBOX = 'dropbox',
    BOX = 'box',
  ...
  export enum ConnectorNames {
    ...
    MICROSOFT_BUSINESS_CENTRAL = 'Microsoft Dynamics 365 Business Central',
    SAP = 'SAP',
    SLACK = 'Slack',
    DROPBOX = 'Dropbox',
    BOX = 'Box',
  ...
  export const ConnectorIdToNameMap: Record<ConnectorId, string> = {
    ...
    [ConnectorId.MICROSOFT_BUSINESS_CENTRAL]: ConnectorNames.MICROSOFT_BUSINESS_CENTRAL,
