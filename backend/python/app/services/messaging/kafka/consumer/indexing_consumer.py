...
class IndexingKafkaConsumer(IMessagingConsumer):
    ...
    def __apply_backpressure(self) -> None:
        ...
        scheduler_full = (
            ...
            and self._scheduler.pending_count
            ...
            for message in messages:
                ...
                try:
                    ...
                    await self.__resolve_offset(
                        _InFlightOffset(tp, message.offset), done=False
                    )
                    self.__seek_back(tp, message.offset)
                    break
    ...
    async def __resolve_offset(
        self, in_flight: "_InFlightOffset | None", *, done: bool
    ) -> None:
        ...
        async def do_resolve() -> None:
            ...
            watermark = (
                ...
                if done
                else offset_tracker.mark_redeliver(tp, offset)
            )
